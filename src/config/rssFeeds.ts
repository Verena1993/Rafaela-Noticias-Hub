...
export const RSS_FEEDS: RssFeedConfig[] = [
  ...
  { id: 'sunchales_hoy', name: 'Sunchales Hoy', url: 'https://sunchaleshoy.com.ar/feed/', defaultCategory: 'regional', connectionType: 'edge_function' },
  { id: 'eco_sunchales', name: 'El Eco de Sunchales', url: 'https://elecodesunchales.com.ar/feed/', defaultCategory: 'regional', connectionType: 'rss_direct' },
  ...
  { id: 'esperanza_dia', name: 'Esperanza Día por Día', url: 'https://www.esperanzadiapordia.com.ar/feed/', defaultCategory: 'regional', connectionType: 'rss_direct' },
